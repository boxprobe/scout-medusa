...
publishable_api_keys = Locator(
    name="publishable-api-keys", tag="a",
    bbox=(349, 16, 130, 20),
    scroll_y=0,
    pos_type="abs",
)
...
revoke_api_key_confirm = Locator(
    name="revoke-api-key-confirm", tag="button",
    bbox=(1024, 572, 111, 28),
    scroll_y=0,
    pos_type="abs",
)
delete_menu_3 = Locator(
    name="delete-menu-3", tag="button",
    bbox=(1806, 81, 28, 28),
    scroll_y=0,
    pos_type="abs",
)
delete_button_3 = Locator(
    name="delete-button-3", tag="div",
    bbox=(1696, 163, 212, 32),
    scroll_y=0,
    pos_type="abs",
)
...
no_results_text = Locator(
    name="no-results-text", tag="h1",
    bbox=(306, 81, 589, 28),
    scroll_y=0,
    pos_type="abs",
)
...
async def test(page: Page):
    ...
    await page.goto("/settings/publishable-api-keys")  # step 5
    await page.wait(2000)
    try:
        await page.pw.wait_for_url("**/settings/publishable-api-keys*", timeout=5000)
    except Exception as _e:
        raise AssertionError("step 5: url_match /settings/publishable-api-keys — " + str(_e)) from _e
    ...
    await page.click(publishable_api_keys)  # step 9
    await page.wait(2000)
    await page.set_step(10)
    await page.fill(search_text, _run_title_input)  # step 10
    await page.wait(2000)
    ...
    await page.click(save_button_2)  # step 14
    await page.wait(2000)
    await page.set_step(15)
    await page.click(edit_menu_2)  # step 15
    await page.wait(2000)
    await page.set_step(16)
    await page.click(revoke_button)  # step 16
    await page.wait(2000)
    await page.set_step(17)
    await page.click(revoke_api_key_confirm)  # step 17
    await page.wait(3000)
    await page.set_step(18)
    await page.click(delete_menu_3)  # step 18
    await page.wait(2000)
    await page.set_step(19)
    await page.click(delete_button_3)  # step 19
    await page.wait(2000)
    await page.set_step(20)
    await page.click(delete_confirm_button)  # step 20
    await page.wait(2000)
    ...
    _hit_el = await page.pw.evaluate(
        ...
        [600, 95, "Publishable API Keys"]
    )
    assert _hit_el is not None, "step 21: text_matched — no element at bbox center"
    assert _hit_el == "Publishable API Keys", f"step 21: text_matched — expected \"Publishable API Keys\", got {_hit_el!r}"
    await page.click(no_results_text)  # step 21
    await page.wait(2000)
