...
campaigns_title = Locator(
    name="campaigns-title", tag="h1",
    bbox=(306, 81, 97, 28),
    scroll_y=0,
    pos_type="abs",
)
...
identifier_input = Locator(
    name="identifier-input", tag="input",
    bbox=(968, 227, 352, 32),
    scroll_y=0,
    pos_type="abs",
)
description_input = Locator(
    name="description-input", tag="textarea",
    bbox=(600, 303, 720, 60),
    scroll_y=0,
    pos_type="abs",
)
usage_radio = Locator(
    name="usage-radio", tag="button",
    bbox=(600, 596, 352, 86),
    scroll_y=0,
    pos_type="abs",
)
limit_input = Locator(
    name="limit-input", tag="input",
    bbox=(600, 741, 352, 32),
    scroll_y=0,
    pos_type="abs",
)
...
list_campaign_name = Locator(
    name="list-campaign-name", tag="h1",
    bbox=(306, 81, 17, 28),
    scroll_y=0,
    pos_type="abs",
    dynamic={'w': True},
...
updated_campaign_name = Locator(
    name="updated-campaign-name", tag="h1",
    bbox=(306, 81, 40, 28),
    scroll_y=0,
    pos_type="abs",
    dynamic={'w': True},
...
no_records_text = Locator(
    name="no-records-text", tag="p",
    bbox=(1036, 192, 68, 20),
    scroll_y=0,
    pos_type="abs",
)
...
async def test(page: Page):
    ...
    await page.goto("/campaigns")  # step 5
    await page.wait(2000)
    try:
        await page.pw.wait_for_url("**/campaigns*", timeout=5000)
    except Exception as _e:
        raise AssertionError("step 5: url_match /campaigns — " + str(_e)) from _e
    ...
    assert _hit_el is not None, "step 7: text_matched — no element at bbox center"
    assert _hit_el == "Create", f"step 7: text_matched — expected \"Create\", got {_hit_el!r}"
    await page.click(create_1)  # step 7
    await page.wait(2000)
    await page.set_step(8)
    _run_name_input = ("test-" + secrets.token_hex(4)[:6])
    await page.fill(name_input, _run_name_input)  # step 8
    await page.wait(2000)
    await page.set_step(9)
    _run_identifier_input = ("test-" + secrets.token_hex(4)[:6])
    await page.fill(identifier_input, _run_identifier_input)  # step 9
    await page.wait(2000)
    await page.set_step(10)
    _run_description_input = ("test-" + secrets.token_hex(4)[:6])
    await page.fill(description_input, _run_description_input)  # step 10
    await page.wait(2000)
    await page.set_step(11)
    await page.click(usage_radio)  # step 11
    await page.wait(2000)
    await page.set_step(12)
    await page.fill(limit_input, "100")  # step 12
    await page.wait(2000)
    await page.set_step(13)
    await page.click(create_2)  # step 13
    await page.wait(2000)
    await page.set_step(15)
    await page.click(edit_menu)  # step 15
    await page.wait(2000)
    await page.set_step(16)
    await page.click(edit_button)  # step 16
    await page.wait(2000)
    await page.set_step(17)
    _run_new_name_input = ("test-" + secrets.token_hex(4)[:6])
    await page.fill(new_name_input, _run_new_name_input)  # step 17
    await page.wait(2000)
    await page.set_step(18)
    await page.click(save_button)  # step 18
    await page.wait(2000)
    await page.set_step(20)
    await page.click(edit_menu_2)  # step 20
    await page.wait(2000)
    await page.set_step(21)
    await page.click(delete_button)  # step 21
    await page.wait(2000)
